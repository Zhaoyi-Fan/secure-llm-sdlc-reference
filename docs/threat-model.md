...
|---|---|---|---|
| Cross-customer order access (BOLA) | Attacker has a valid account and guesses another order ID | Repository queries include both object ID and authenticated user ID; non-owned objects return 404 | `test_case_01_object_authorization.py` |
